...
Please install these Plasma widgets after the running the cript, but before applying the Latte Dock layout: Latte Separator, Latte Spacer, Window Title Applet, Better Inline Clock
"
